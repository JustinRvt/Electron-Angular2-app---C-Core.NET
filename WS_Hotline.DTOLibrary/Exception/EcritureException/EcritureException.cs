...
namespace WS_Hotline.DTOLibrary.Exception.EcritureException
{
    ...
    [Serializable]
    public class EcritureException : BaseDTOException<EcritureDTO>
    {
        #region Constructeur
        ...
        /// <remarks>ylouis - 06/09/2016 - Généré par Template T4 v1.0 </remarks>
        public EcritureException(string pMessage): base(pMessage)
        { }
        ...
        /// <remarks>ylouis - 06/09/2016 - Généré par Template T4 v1.0 </remarks>
		public EcritureException(System.Exception pInnrException)
            : base(pInnrException)
        { }
        ...
        /// <param name="pInnrException">Inner exception</param>
        /// <remarks>ylouis - 06/09/2016 - Généré par Template T4 v1.0 </remarks>
        public EcritureException(string pMessage, System.Exception pInnrException)
        ...
        /// <remarks>ylouis - 06/09/2016 - Généré par Template T4 v1.0 </remarks>
        protected  EcritureException(SerializationInfo pInfo, StreamingContext pContext): base (pInfo,pContext)
        { }
