...
namespace WS_Hotline.DataAccessLayer.Entities.Ecriture
{
    /// <summary>
    /// Classe de configuration de EcritureDTO
    /// </summary>
    /// <remarks>ylouis - 06/09/2016 - Généré par Template T4 v1.0</remarks>
    public class EcritureConfiguration : EntityTypeConfiguration<EcritureDTO>, IEntityConfiguration
    {
        #region METHODS
