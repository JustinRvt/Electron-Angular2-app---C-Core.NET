...
namespace Demo.DataAccessLayer.Entities.Compte
{
    /// <summary>
    /// Classe data acess layer de Compte
    /// </summary>
    /// <remarks>ylouis - 06/09/2016 - Généré par Template T4 v1.0</remarks>
    public class CompteDAL : Repository<CompteDTO, DemoDbContext>
    {
        #region CSTR
        ...
        /// <remarks>ylouis - 06/09/2016 - Création</remarks>
        public CompteDAL(DemoDbContext pContext)
            : base(pContext)
        {
            // yl - Gestion des Lien vers les autres tables
            this.GestionInclude();
        ...
        /// <remarks>ylouis - 06/09/2016 - Création</remarks>
        private IQueryable<CompteDTO> IncludeListEcriture(IQueryable<CompteDTO> pSource, Expression<Func<CompteDTO, object>> arg2, Framework.Domain.Query.SearchCriteria<CompteDTO> arg3)
        {
            // yl - retourne liens
